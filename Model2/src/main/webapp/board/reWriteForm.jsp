...
<article>
<h1>게시판 답글쓰기</h1>
	<!-- 전달할 정보 있음 bno, pageNum, re_ref, re_lev, re_seq -->
<form action="./BoardReWriteAction.bo?pageNum=${param.pageNum }" method="post">
	...
	<table id="notice">
		<tr>
		    <th class="ttitle" colspan="2">게시판 답글쓰기(Re_Create)</th>
		</tr>
		<tr>
		<td class="left">글쓴이  </td><td  class="left"><input type="text" name="name"></td>
		</tr>
		<tr>
		<td class="left">제목  </td><td class="left"><input type="text" name="subject" value="[답글]"></td>
		</tr>
		<tr>
		<td class="left">내용  </td><td  class="left"><textarea rows="10" cols="20" name="content"></textarea></td>
		</tr>
		<tr>
		<td class="left">비밀번호  </td><td  class="left"><input type="password" name="pass"></td>
		</tr>
	</table>
